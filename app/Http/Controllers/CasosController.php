...
public function updateCaso(Request $request)
{
    ...
    try {
        DB::statement('CALL sp_ActualizarCasoYLesionado(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [
            ...
            $request->input('p_FechaInicio') ? Carbon::createFromFormat('d/m/Y', $request->input('p_FechaInicio'))->format('Y-m-d') : null,
            $request->input('p_FechaFin') ? Carbon::createFromFormat('d/m/Y', $request->input('p_FechaFin'))->format('Y-m-d') : null,
