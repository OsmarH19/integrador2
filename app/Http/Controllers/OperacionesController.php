...
class OperacionesController extends Controller
{
    public function DatosFormulario()
    {
        ...
        return view( 'pages.entes.EntesForm', compact( 'catpais','tipocontacto' , 'tipodireccion', 'tipoidentificacion', 'ocupacion', 'tipoente', 'lugaremision', 'tratamiento', 'jurisdiccion', 'clasificacion', 'titulocontacto' ) );
    }
