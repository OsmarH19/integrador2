                ...
                <div class="card p-4 sm:p-5">
                    <div class="flex items-center space-x-4">
                        <div class="avatar size-14">
                            <img class="rounded-full" src="{{ asset($user->photo ? $user->photo : 'images/200x200.png') }}" alt="avatar" />
                        </div>
                        <div>
                            ...
                            <div class="flex flex-col sm:flex-row gap-6">
                                <div class="flex-shrink-0">
                                    <div class="avatar mt-1.5 size-32 sm:size-40">
                                        <img class="mask is-squircle" src="{{ asset($user->photo ? $user->photo : 'images/200x200.png') }}" alt="avatar" />
                                        <div class="absolute bottom-0 right-0 flex items-center justify-center rounded-full bg-white dark:bg-navy-700">
                                            {{-- <button class="btn size-8 rounded-full border border-slate-200 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:border-navy-500 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                                        ...
                                        <label class="block">
                                            ...
                                            <span class="relative mt-1.5 flex">
                                                <input disabled
                                                    ...
                                                    placeholder="Enter name" type="text" name="name" value="{{ old('name', $user->name) }}" />
                                                <span
