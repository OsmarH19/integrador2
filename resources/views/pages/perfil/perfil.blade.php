<x-app-layout title="Mi Perfil" is-header-blur="true">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="avatar size-14">
                            <img class="rounded-full"
                                src="{{ asset($user->photo ? $user->photo : 'images/200x200.png') }}" alt="avatar" />
                        </div>
                        <div>
                        ...
                        <div
                            ...
                            <div class="flex justify-center space-x-2">
                                ...
                                <button type="button"
                                    ...
                                    <a href="{{ route('dashboards/crm-analytics') }}">Cancelar</a>
                                </button>
                                <button type="submit"
                        ...
                        <div class="p-4 sm:p-5">
                            <div class="flex flex-col sm:flex-row gap-6">
                                <div class="flex-shrink-0">
                                    <div class="avatar mt-1.5 size-32 sm:size-40">
                                        <img class="mask is-squircle"
                                            src="{{ asset($user->photo ? $user->photo : 'images/200x200.png') }}"
                                            alt="avatar" />
                                        ...
                                        <div
                                            ...
                                            <button type="button"
                                                ...
                                                class="btn size-8 rounded-full border border-slate-200 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:border-navy-500 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                ...
                <form id="profile-form" method="POST" action="{{ route('profile.update') }}"
                    ...
                    <div class="card">
                        ...
                        <div class="p-4 sm:p-5">
                            <div class="flex flex-col sm:flex-row gap-6">
                                <div class="flex-shrink-0">
                                    <div class="avatar mt-1.5" style="height: 3rem; width: 18rem; overflow: hidden;">
                                        <img
                                            src="{{ asset($user->empresa && $user->empresa->photo ? $user->empresa->photo : 'images/200x200.png') }}"
                                            alt="empresa-avatar"
                                        ...
                                        <label class="block">
                                            ...
                                            <span class="relative mt-1.5 flex">
                                                <input
                                                    class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                                    placeholder="Enter name" type="text" name="name"
                                                    value="{{ $user->empresa ? $user->empresa->nombre : '' }}" readonly />
                                                <span
                                                    class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
