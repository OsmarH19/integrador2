<x-app-layout title="Datos Maestros" is-header-blur="true">
    ...
    <div id="TipoCatalogo">
                                    ...
                                    <tr class="hover:bg-slate-50 dark:hover:bg-navy-600">
                                        ...
                                        <td class="whitespace-nowrap px-3 py-2">
                                            <div class="flex space-x-1">
                                                ...
                                                <button @click="MostrarDetallesCatalogo({{ $item->TipoID }})"
                                                    class="btn size-7 p-0 text-info hover:bg-info/20 focus:bg-info/20 active:bg-info/25">
        ...
        <div id="DetallesCatalogo" class="hidden">
            <!-- vista de detalles -->
        </div>
    </main>
    <script>
        function MostrarDetallesCatalogo(tipoId){
            // Ocultar la sección de tipos de catálogo
            document.getElementById('TipoCatalogo').classList.add('hidden');

            // Mostrar el contenedor de detalles
            const detallesContainer = document.getElementById('DetallesCatalogo');
            detallesContainer.classList.remove('hidden');

            // Cargar la vista de detalles
            fetch(`/apps/mantenimiento/datoscatalogo/${tipoId}`)
        ...
        function VolverATiposCatalogo() {
            document.getElementById('DetallesCatalogo').classList.add('hidden');
            document.getElementById('TipoCatalogo').classList.remove('hidden');
        }
