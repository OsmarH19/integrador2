<div class="main-sidebar">
    <div
        ...
        <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
            ...
            <!-- MANTENIMIENTO -->
            @if (Auth::user()->rolID == 12)
            <a href="{{ route('apps/mantenimiento') }}"
                ...
                x-tooltip.placement.right="'Mantenimiento'">
                <svg class="size-7" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <!-- Pages And Layouts -->
            <a href="{{ route('layouts/Registroscasos') }}"
                ...
                x-tooltip.placement.right="'Operaciones'">
        ...
        <div class="flex flex-col items-center space-y-3 py-3">
            ...
            <div x-data="usePopper({ placement: 'right-end', offset: 12 })" @click.outside="if(isShowPopper) isShowPopper = false" class="flex">
                <button @click="isShowPopper = !isShowPopper" x-ref="popperRef" class="avatar size-12 cursor-pointer">
                    @props(['user'])
                    <img class="rounded-full" src="{{ asset($user->photo ?? 'images/200x200.png') }}" alt="avatar" />
                    <span
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-4 rounded-t-lg bg-slate-100 py-5 px-4 dark:bg-navy-800">
                            <div class="avatar size-14">
                                <img class="rounded-full" src="{{ asset($user->photo ?? 'images/200x200.png') }}"
                                    alt="avatar" />
                            </div>
                            <div>
                                <a id="nombreusuario" href="#"
