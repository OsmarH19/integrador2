                ...
                <template x-if="$store.breakpoints.smAndUp">
                    <div class="flex" x-data="usePopper({ placement: 'bottom-end', offset: 12 })" @click.outside="if(isShowPopper) isShowPopper = false">
                        <div class="relative mr-4 flex h-8">
                            <div class="flex h-full w-56 items-center justify-center text-slate-400 dark:text-navy-300">
                                <img class="size-11 w-56 transition-transform duration-500 ease-in-out"
                                    src="{{ asset(auth()->user()->empresa && auth()->user()->empresa->photo ? auth()->user()->empresa->photo : 'images/default-empresa.png') }}"
                                    alt="Logo Empresa" />
                            </div>
                        </div>
                    </div>
